class Level {
    ...
    public Level(int num_rows, int spots_per_row) {
        ...
        for (int row = 0; row < num_rows; ++row) {
            for (int spot = 0; spot < spots_per_row / 4; ++spot) {
                ...
                spots[numberSpots] = new ParkingSpot(this, null,row, numberSpots, sz);
                numberSpots ++;
            }
            for (int spot = spots_per_row / 4; spot < spots_per_row; ++spot) {
    ...
    public void print() {  
      ...
      System.out.print("Remaining Slots: " + availableSpots); 
    }
}
